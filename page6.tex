...
{\fontsize{30}{1}\scshape Keily Whisper}
\textrm{\fontsize{26}{1} \ding{66}}}
	\placetextbox{0}{0.9}{\paperwidth}{\fontsize{14}{1}\centering\addfontfeature{LetterSpace=0} \textit{A magic-wielding thief, first mate and mechanic of} The Owl}
...
\textit{You must safely deliver Lady Blackbird to the Pirate Queen Aria
Flame, so she can marry her. Hit your key when you take action to
complete the mission.}
Buyoff: Give up the mission. \vspace{17pt} \\
\textit{You are sworn to Captain Vance in a bond of sisterhood. Hit your
key when your character is influenced by Vance or when you show
how deep your bond is.}
Buyoff: Sever the relationship or admit to be in love with her. \vspace{17pt} \\
