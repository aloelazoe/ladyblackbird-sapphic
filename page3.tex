...
{\fontsize{30}{1}\scshape Lady Blackbird}}
	\placetextbox{0}{0.9}{\paperwidth}{\fontsize{14}{1}\centering\itshape\addfontfeature{LetterSpace=0} An Imperial noble, in disguise, escaping an arranged marriage so she can be with her pirate girlfriend}
...
Key of the Mission \vspace{52pt} \\
Key of the Impostor \vspace{47pt} \\
Secret of Stormblood \vspace{37pt} \\
...
lover, the Pirate Queen Aria Flame, whom you haven’t seen in six
...
Sorcery. You have the Sorceress trait and the Stormblood tag.} \vspace{17pt} \\
